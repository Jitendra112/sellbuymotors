...
--
-- Host: localhost:3306
-- Generation Time: Jan 10, 2019 at 12:00 PM
...
CREATE TABLE `tbl_products` (
  ...
  `car_comes` varchar(700) NOT NULL,
  `economy_perform` varchar(700) NOT NULL,
  `driver_convenience` varchar(700) NOT NULL,
  `safety` varchar(700) NOT NULL,
  `exterior_feat` varchar(700) NOT NULL,
  `interior_feat` varchar(700) NOT NULL,
  `technical` varchar(700) NOT NULL,
...
(8, '2019', '35000', 'Aston Martin', 'DB7', 'GTA', 'Blue', 'Estate', 'Hybrid – Diesel&#x2F;Electric', '3.5', '50+ mp', '8-12s (0-60mph)', 'Automatic', 'All Wheel Drive', 'Up to 100 g &#x2F; km CO2', '3DR', '6', '20', 'Up to €130', 'Private adverts', 'first owner', 'New', '120000', 'The passage experienced a surge in popularity during the 1960s when Letraset used it on their dry-transfer sheets, and again during the 90s as desktop publishers bundled the text with their software. Today it&#x27;s seen', 'Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts of Cicero&#x27;s De Finibus Bonorum et Malorum for use in a type specimen book. It usually begins with:', 'Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts of Cicero&#x27;s De Finibus Bonorum et Malorum for use in a type specimen book. It usually begins with:', 'The passage experienced a surge in popularity during the 1960s when Letraset used it on their dry-transfer sheets, and again during the 90s as desktop publishers bundled the text with their software. Today it&#x27;s seen', 'Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts of Cicero&#x27;s De Finibus Bonorum et Malorum for use in a type specimen book. It usually begins with:', 'The passage experienced a surge in popularity during the 1960s when Letraset used it on their dry-transfer sheets, and again during the 90s as desktop publishers bundled the text with their software. Today it&#x27;s seen', 'The passage experienced a surge in popularity during the 1960s when Letraset used it on their dry-transfer sheets, and again during the 90s as desktop publishers bundled the text with their software. Today it&#x27;s seen', 'Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts of Cicero&#x27;s De Finibus Bonorum et Malorum for use in a type specimen book. It usually begins with:', 'The passage experienced a surge in popularity during the 1960s when Letraset used it on their dry-transfer sheets, and again during the 90s as desktop publishers bundled the text with their software. Today it&#x27;s seen', '2019-01-10 06:03:13');
